...
local FireBreath = script.DamagePart
local FirePE = Fire.Handle.Fire
...
local PlayersHit = {}
FireBreath.Touched:Connect(function(hit)
...
while wait(.5) do
	pcall(function()
		...
		elseif Target.Parent:FindFirstChildOfClass("Humanoid").Health > 0 and Stunned == false then
			...
			FirePE.Enabled = true
			FireBreath.CFrame = HumanoidRootPart.CFrame * CFrame.new(0,0,-20)
