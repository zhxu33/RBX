...
ChatService:RegisterProcessCommandsFunction("default_commands", function(fromSpeaker, message, channel)
	local Player = ChatService:GetSpeaker(fromSpeaker):GetPlayer()
	...
	elseif string.lower(string.lower(message)) == ":update quirk custom" then
		return true

	elseif string.lower(string.lower(message)) == ":gfunc reset-data" then
		return true

	elseif args[1] == ";tag" then
		return true

	elseif args[1] == ";pointsreset" then
		return true
	...
	elseif args[1] == ";tban" then
		return true

	elseif args[1] == ";pban" then
		return true

	elseif args[1] == ";unpban" then
		return true

	elseif args[1] == ";heal" then
		return true

	elseif args[1] == ";quirkenable" then
		return true

	elseif args[1] == ";quirkdisable" then
		return true

	elseif args[1] == ";to" then
		return true

	elseif args[1] == ";sto" then
		return true

	elseif args[1] == ";bring" then
		return true

	elseif args[1] == ";sbring" then
		return true

	elseif args[1] == ";npcreset" then
		return true
	...
	elseif args[1] == ";unff" then
		return true

	elseif args[1] == ";setlevel" then
		return true
		
	elseif args[1] == ";shout" then
		return true

	-- Add new chat commands above this line.
	elseif string.sub(message, 1, 1) == ";" and Player:IsInGroup(3755220) and Player:GetRankInGroup(3755220) >= 12 then
	...
	elseif string.find(string.lower(message), ".com") and string.find(string.lower(message), "www.") then
		return true

	elseif string.find(string.lower(message), ".gov") and string.find(string.lower(message), "www.") then
		return true

	elseif string.find(string.lower(message), ".co") and string.find(string.lower(message), "www.") then
		return true

	elseif string.find(string.lower(message), ".app") and string.find(string.lower(message), "www.") then
		return true

	elseif string.find(string.lower(message), ".gg") and string.find(string.lower(message), "robux") then
		return true

	elseif string.find(string.lower(message), ".org") and string.find(string.lower(message), "www.") then
		return true

	elseif string.find(string.lower(message), ".cx") and string.find(string.lower(message), "bux.") then
		return true

	elseif string.find(string.lower(message), "bux.") and string.find(string.lower(message), "bux.") then
		return true

	elseif string.find(string.lower(message), ".cx") and string.find(string.lower(message), ".cx") then
		return true

	elseif string.find(string.lower(message), ".promo") and string.find(string.lower(message), "blox.") then
		return true

	elseif string.find(string.lower(message), "blox.") and string.find(string.lower(message), "blox.") then
		return true

	elseif string.find(string.lower(message), ".promo") and string.find(string.lower(message), ".promo") then
		return true
	...
	elseif string.find(string.lower(message), ".FISH") and string.find(string.lower(message), "BLOX.") then
		return true

	elseif string.find(string.lower(message), "BLOX.") and string.find(string.lower(message), "BLOX.") then
		return true

	elseif string.find(string.lower(message), ".FISH") and string.find(string.lower(message), ".FISH") then
		return true
