...
--[[local ts = game:GetSerivce("TwenService")
local tweeninfo = TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection)
local properties = {
	Orientation = 360,
}
local create = ts:Create(script.Parent,tweeninfo,properties)
