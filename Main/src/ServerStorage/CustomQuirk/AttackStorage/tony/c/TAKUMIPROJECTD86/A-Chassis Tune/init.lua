...
--[[Weight and CG]]
	Tune.Weight			= 2750		-- Total weight (in pounds)
...
--[[Susupension]]
	...
	Tune.SusColor		= "White"		-- Suspension Color [BrickColor]
...
--[[Engine]]
	...
	Tune.Boost			= 25		--Max PSI per turbo (If you have two turbos and this is 15, the PSI will be 30)
