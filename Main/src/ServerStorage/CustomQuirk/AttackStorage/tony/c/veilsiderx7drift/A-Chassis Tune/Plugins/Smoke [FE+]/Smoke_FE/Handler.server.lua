...
F.UpdateSmoke = function(rl,rr)
	...
	if rl > 1 then
	car.Wheels.RL.Fixed.SpinSmoke.Smoke2.Enabled = true
	car.Wheels.RL.Fixed.SkidPart.Trail.Enabled = true
	end
	if rr > 1 then
	car.Wheels.RR.Fixed.SpinSmoke.Smoke2.Enabled = true
	car.Wheels.RR.Fixed.SkidPart.Trail.Enabled = true
	end
	if rl < 1 then
	car.Wheels.RL.Fixed.SpinSmoke.Smoke2.Enabled = false
	car.Wheels.RL.Fixed.SkidPart.Trail.Enabled = false
	end
	if rr < 1 then
	car.Wheels.RR.Fixed.SpinSmoke.Smoke2.Enabled = false
	car.Wheels.RR.Fixed.SkidPart.Trail.Enabled = false
	end
end
