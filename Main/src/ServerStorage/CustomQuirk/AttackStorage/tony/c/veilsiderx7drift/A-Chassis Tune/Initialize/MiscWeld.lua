...
--Left Door
MakeWeld(misc.DoorL.Hinge,car.DriveSeat,"Motor",.1)
ModelWeld(misc.DoorL.Parts,misc.DoorL.Hinge)

--Right Door
MakeWeld(misc.DoorR.Hinge,car.DriveSeat,"Motor",.1)
ModelWeld(misc.DoorR.Parts,misc.DoorR.Hinge)
