...
function supa()
	...
	task.spawn(function()
		while task.wait() and Clone.Parent do
...
while task.wait(.5) do
	pcall(function()
		...
		elseif Target.Parent == nil then 
			Target = nil
		elseif (Target.Position - OriginalCFrame.Position).magnitude > 500 then
			Character:SetAttribute("Target", 0)
			Humanoid:MoveTo(OriginalCFrame.Position)
			Target = nil
		elseif (HumanoidRootPart.Position - OriginalCFrame.Position).magnitude > 500 then
